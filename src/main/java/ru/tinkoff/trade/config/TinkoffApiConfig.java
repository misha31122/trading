...
public class TinkoffApiConfig {
  ...
  public RestTemplate tinkoffApiRestTemplate() {
    ...
    restTemplate.setMessageConverters(singletonList(prepareEpaSpecificMessageConverter()));
    return restTemplate;
  }
  ...
  private MappingJackson2HttpMessageConverter prepareEpaSpecificMessageConverter() {
